    ...
    <section className="min-h-screen pt-12">
      <div className="container mx-auto">
        ...
        <Tabs defaultValue={category} className="mb-24 xl:mb-48">
          <TabsList className="mx-auto mb-12 grid h-full w-full grid-cols-2 dark:border-none md:grid-cols-3 md:border lg:max-w-[720px]">
          ...
          {/* tabs content */}
          <div className="grid grid-cols-1 gap-4 text-lg md:grid-cols-2 xl:mt-8">
